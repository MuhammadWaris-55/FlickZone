    ...
    >
      <Link to={`/watch/${video._id}`}>
        <motion.div
          ...
          className="group relative rounded-xl overflow-hidden bg-card border border-border transition-shadow duration-300 hover:shadow-[0_20px_50px_-12px_var(--color-accent)]"
        >
